...
-- Insert Sample Data into BatchRun Table
...
-- Insert Sample Data into JobRun Table
...
-- Insert Sample Data into JobArguments Table
...
/* Note: Primary keys and foreign key relationships should be managed at the application level or with Delta capabilities, as native constraints are not directly supported in Databricks SQL. */
